    ...
    <section className="relative bg-bg-elevated px-6 py-16 md:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative mx-auto max-w-2xl">
          <div className="absolute left-[23px] top-0 hidden h-full w-px bg-gradient-to-b from-cobalt/50 via-cobalt/20 to-transparent md:left-[27px] md:block" />
            ...
            {steps.map((step, i) => (
              <div key={step.num} className="group flex items-start gap-5" style={{ animation: `fade-up 0.6s ease-out ${0.15 * i}s both` }}>
                ...
                <div className="glass rounded-xl px-5 py-4 flex-1 transition-all duration-300 group-hover:bg-white/[0.05]">
                  ...
                  <p className="text-xs text-text-muted md:text-sm">{step.desc}</p>
                  {i === 1 && (
                    <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-cobalt/10 px-2.5 py-0.5 text-[10px] font-medium text-cobalt">
